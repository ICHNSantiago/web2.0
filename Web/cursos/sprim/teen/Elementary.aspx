<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Elementary.aspx.cs" Inherits="Web.cursos.sprim.teen.Elementary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Spring Program | Elementary - Teens</title>
                    ...
                    <div class="bg-white rounded p-5 ">
                        <div class="row ">
                            <div class="col-md-9">
                                ...
                                <h5 class="display-6">Teens  | <span class="text-primary">Elementary</span></h5>
                                <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" runat="server" id="div_descripcion" visible="false">
                                <div class="row mt-5 text-dark">
                                    <div class="col-md-12">
                                        <h2>Spring Program Teens  | <span class="text-primary">Elementary</span></h2>
                                        <hr />
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="mt-5">
                                    ...
                                    <table class="table mb-5 mt-3 text-dark">
                                        <tr>
                                            ...
                                            <td>Comprender instrucciones básicas o ser parte de una conversación factual sobre un tema predecible.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Hacer preguntas simples de naturaleza factual y comprender respuestas expresadas en lenguaje simple.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Comprender instrucciones básicas sobre horarios, fechas, números, y sobre tareas que se deben completar.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Comprender textos de audio con información específica simple</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Iniciar una conversación con base en modelos de información familiar.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Comprender noticias, instrucciones, información en lugares públicos como aeropuertos y tiendas, en trípticos y en menús.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Comprender instrucciones simples sobre medicamentos, y direcciones para lllegar a lugares.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Leer y comprender textos simplifciados y artículos que contienen información predecible.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                            <td>Reconocer cognados y hacer asociaciones.</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                ...
                                <div class="counter-item bg-light rounded p-3 h-100">
                                    <div class="counter-counting">
                                        <div class="row g-4 justify-content-center">
                                            <div class="col-md-8">
                                                <i class="fas fa-bookmark text-success fs-4"></i>
                                                <span class="text-dark fs-4 fw-bold">Teens - Pre Intermediate</span>
                                            </div>
                                            <div class="col-md-4">
                                                <a class="btn btn-success py-2 px-4" href="PreIntermediate.aspx">Saber más</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
