<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Beginner.aspx.cs" Inherits="Web.cursos.sprim.teen.Beginner" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Spring Program | Beginner - Teens</title>
                    ...
                    <div class="bg-white rounded p-5 ">
                        <div class="row ">
                            <div class="col-md-9">
                                ...
                                <h5 class="display-6">Teens  | <span class="text-primary">Beginner</span></h5>
                                <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" runat="server" id="div_descripcion" visible="false">
                                <div class="row mt-5 text-dark">
                                    <div class="col-md-12">
                                        <h2>Spring Program Teens  | <span class="text-primary">Beginner</span></h2>
                                        <hr />
                                    </div>
                                    <div class="col-md-2">
