<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Teen.aspx.cs" Inherits="Web.cursos.MiddleTerm.Teen" %>
                    ...
                    <div class="rounded bg-light p-5">
                        <div class="row ">
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12">
                                        <span class="display-6 text-dark">Middle Term | <span class="text-primary">Teens </span></span>
                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-grid gap-2">
                                                        <a href="../../Contact.aspx?programa=Middle_Term_Teen" class="btn btn-primary"><i class="fas fa-user-tie me-2"></i>Contáctenos </a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                            <div class="row mt-5  mb-5 text-dark">
                                                <div class="col-md-12">
                                                    <h4>Descripción | <span class="text-primary">Curso para adolescentes </span></h4>
                                                    <hr />
                                                </div>
                                                <div class="col-md-12">
                                                    <div style="text-align: justify">
                                                      Curso de Inglés nivel para adolescentes diseñado para alumnos sin contacto con contextos de habla inglesa, donde la exposición primera al idioma es la oportunidad para practicar en la sala de clases.<br />
                                                        <br />
                                                        Provee un ambiente mejorado de aprendizaje para estudiantes que ya cuentan de la instrucción en el idioma como parte del curriculum escolar y requieren de un programa que desarrolle sus habilidades comunicativas.
                                                        </div>
                                                </div>
                                                <div class="col-md-12 mt-5">
                                                    ...
                                                    <table class="table mb-5 mt-3 text-dark">
                                                        ...
                                                        <tr>
                                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                                            <td>Hacer preguntas de naturaleza factual y comprender respuestas en lenguaje simple.</td>
                                                        </tr>
                                                        <tr>
                                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                                        ...
                                                        <tr>
                                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                                            <td>Comprender textos de audio en busca de información específica.</td>
                                                        </tr>
                                                        <tr>
                                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                                        ...
                                                        <tr>
                                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                                            <td>	Comprender noticias simples, instrucciones o información en aeropuertos, tiendas y en menús.</td>
                                                        </tr>
                                                        <tr>
                                                            <td><i class="fas fa-bookmark text-primary"></i></td>
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mt-2" style="text-align: justify">
                                                                    ...
                                                                    <hr />
                                                                    Curso de Inglés nivel inicial para adolescentes diseñado para alumnos sin contacto con contextos de habla inglesa, donde la exposición primera al idioma es la oportunidad para practicar en la sala de clases. De esta forma, las actividades de interacción completamente en inglés son el primer modelo y guía para convertirse en eventuales hablantes de este idioma. Los contenidos del curso incluyen la familiarización con el lenguaje en sí para el desarrollo de competencias lingüísticas que requieren la reflexión sobre las habilidades comunicativas ya adquiridas y transversales al currículum escolar e invita a vivir experiencias con Realidad Virtual para consolidar aprendizajes mediante el uso de Casco de VR 3D con controladores en clase.
                                                               </div>                                                               
                                                            </div>
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="row">
                                                                <div class="col-md-12 mt-2" style="text-align: justify">
                                                                 ...
                                                                 Curso de Inglés  para adolescentes estructurado específicamente para la práctica de cuatro habilidades en contextos variados y contextualizados. Provee un ambiente mejorado de aprendizaje para estudiantes que ya cuentan de la instrucción en el idioma como parte del curriculum escolar y requieren de un programa que desarrolle sus habilidades comunicativas. Entrega, además, las herramientas necesarias para operar en ambientes de habla inglesa e invita a vivir experiencias con Realidad Virtual para consolidar aprendizajes mediante el uso de Casco de VR 3D con controladores en clase.  </p>
                                                                    <hr />
                                                                </div>
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="row">
                                                                <div class="col-md-12 mt-2" style="text-align: justify">
                                                                    ...
                                                                    <p style="text-align: justify;">
                                                                        Curso de inglés para adolescentes con contenidos estructurados para el desarrollo del vocabulario en ejercicios e interacción controlados; con práctica de habilidades para la comprensión y preparación de pruebas estandarizadas. Con exposición a la producción activa del idioma, el nivel pre- intermedio consolida las competencias adquiridas en los dos niveles anteriores como primer acercamiento a las funciones metalingüísticas del inglés e invita a vivir experiencias con Realidad Virtual para consolidar aprendizajes mediante el uso de Casco de VR 3D con controladores en clase.
                                                                    </p>
                                                                    <hr />
                                                                </div>                                                              
                                                            </div>
                        ...
                        <div class="alert">
                            <div class="row">
                                <div class="col-md-12  text-center">
                                    <img src="../../img/programas/BANNERTEENS2.png" class="img-fluid rounded w-100" alt="">
                                </div>
                              <%--  <div class="col-md-12" runat="server" id="div_inicio">
                               ...
                               <%-- <div class="col-md-12 mt-3">
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="d-grid gap-2">
                                        <a href="../../Contact.aspx?programa=Middle_Term_Teen" class="btn btn-primary">Contáctenos </a>
                                    </div>
                                </div>
                            </div>
                        </div>
