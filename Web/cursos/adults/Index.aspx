                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                            <div class="row mt-5 text-dark">
                                                ...
                                                <div class="col-md-3">
                                                    <img src="../../img/programas/summer_teens_kid.png" class="img-fluid rounded w-100" alt="">
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="mt-5">
                                                        <h4>English | <span class="text-primary">Summer School</span></h4>

                                                        <table class="table text-dark">
                                                            <tr>
                                                                <td>
                                                                    <span class="text-primary"><i class="fas fa-calendar-check me-2"></i>Inicios</span>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="text-primary"><i class="fas fa-clock me-2"></i>Duración</span>
                                                                </td>
                                                                <td>
                                                                    <span>Un mes (4 clases por semana)</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="text-primary"><i class="fas fa-book me-2"></i>Metodología</span>
                                                                </td>
                                                                <td>
                                                                    <span>STEAM y Learning by Doing</span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="col-md-12 mt-5">
                                                    ...
                                                    <h4>Acerca de | <span class="text-primary">Summer School</span></h4>
                                                    <hr />

                                                    <span>
                                                        <h5>Este verano aprende inglés y descubre nuevas aventuras.</h5>

                                                        Incluye 3 emocionantes talleres con experimentos realizados junto a los tutores bilingües de <a href="www.thinkey.cl" target="_blank">www.thinkey.cl</a></span>
                                                    <br />
                                                    <br />

                                                    <small>Observación: Estudiantes que llegan por renovación deben solicitar homologación hacia el nivel más próximo abierto por temporada de verano.</td>
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
