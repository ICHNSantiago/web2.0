<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Shop.aspx.cs" Inherits="Web.cursos.adults.Shop" %>
    ...
    <div class="container-fluid bg-light service py-5">
        <div class="container py-5">
            ...
            <div class="row g-4 justify-content-center">
                            ...
                            <div class="service-content-inner">
                                <table class="table text-dark">
                                    <tr class="text-center">
                                        <th colspan="2">
                                            <h3>Curso de Inglés<br />
                                                <strong class="text-primary">Intensivo</strong>
                                            </h3>
                                        </th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="text-center">
                                        <th colspan="2">
                                            <div class="d-grid gap-2">
                                                <a class="btn btn-primary rounded-pill py-2 px-4" href="ShopCart.aspx?tipo=intensivo"><i class="fas fa-shopping-cart me-2"></i>Seleccionar</a>
                                            </div>
                                        </th>
                                    </tr>
                                </table>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s" runat="server" id="div_summer" >
                    <div class="service-item shadow">
                        <div class="service-img">
