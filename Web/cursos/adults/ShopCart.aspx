<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="ShopCart.aspx.cs" Inherits="Web.cursos.adults.ShopCart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluidabout  bg-light py-5">
        <div class="container py-2">
            ...
            <div class="mb-5" runat="server" id="shop_oferta">
                <%--<img src="" runat="server" id="img_oferta" class="img-fluid rounded shadow-lg" alt="" />--%>
            </div>
            ...
            <div class="row g-4 bg-white" runat="server" id="shop_programa">
                ...
                <div class="col-md-6">
                    <table class="table table-sm text-dark" runat="server" id="table_summer" visible="false" style="font-size: 18px">
                        <tr>
                            <td style="width: 40%">Curso de Inglés</td>
                            <th>
                                <span class="text-primary">Adultos</span>
                            </th>
                        </tr>
                        <tr>
                            <td style="width: 40%">Modalidas del Curso</td>
                            <th>
                    ...
                    <table class="table table-sm text-dark mb-0" runat="server" id="table_regular" visible="false" style="font-size: 14px">
                        ...
                        <tr>
                            <td>Inicios *</td>
                            <th><i class="fas fa-calendar me-2"></i>Mar | May | Ago | Oct</th>
                        </tr>
                    </table>

                    <table class="table table-sm text-dark mb-0" runat="server" id="table_intensivo" visible="false" style="font-size: 14px">
                        <tr>
                            <td style="width: 40%">Curso de Inglés</td>
                            <th>
                                <span class="text-primary">Adultos</span>
                ...
                <div class="col-md-4">
                    <table class="table text-dark table-borderless " style="font-size: 16px">
                        ...
                        <%--  <tr>
                            <td colspan="3">
                                <img src="../../img/oferta.png" class="img-fluid rounded" alt="" />
                            </td>
                        </tr>--%>
            ...
            <div class="row g-4" runat="server" id="shop_pago" visible="false">
                    ...
                    <div class="alert alert-light">
                        ...
                        <table class="table table-sm table-borderless text-dark">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div id="nombre" style="display: block;">
                                        <asp:TextBox ID="TextBoxAlumnoRun" oninput="checkRut(this)" AutoPostBack="true" CssClass="form-control text-dark" runat="server" OnTextChanged="TextBoxAlumnoRun_TextChanged"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <span>
                                        <asp:TextBox ID="TextBoxAlumnoNombre" CssClass="form-control text-dark" runat="server"></asp:TextBox>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <span>
                                        <asp:TextBox ID="TextBoxAlumnoPaterno" CssClass="form-control text-dark" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <span>
                                        <asp:TextBox ID="TextBoxAlumnoMaterno" CssClass="form-control text-dark" runat="server"></asp:TextBox>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <span>
                                        <asp:TextBox ID="TextBoxAlumnoNace" onkeydown="fechas(event);" placeholder="ejemplo: 01-01-2000" CssClass="form-control text-dark" runat="server"></asp:TextBox>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>
                                        <asp:TextBox ID="TextBoxAlumnoFono" MaxLength="9" CssClass="form-control text-dark" runat="server"></asp:TextBox>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <span>
                                        <asp:TextBox ID="TextBoxAlumnoMail" AutoPostBack="true" CssClass="form-control text-dark" runat="server" OnTextChanged="TextBoxAlumnoMail_TextChanged"></asp:TextBox>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ListaRegion" class="form-select text-dark" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ListaRegionAlumno_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ListaComuna" AutoPostBack="true" class="form-select text-dark" runat="server" OnSelectedIndexChanged="ListaComuna_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:TextBox ID="TextBoxAlumnoDireccion" AutoComplete="off" CssClass="form-control text-dark" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-5">
                                ...
                                <table class="table text-dark">
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <span>$
                                                <asp:Label ID="LabelProductoMonto" runat="server" Text="Label"></asp:Label></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <div class="col-md-8 text-center presente">
                                <table class="table">
                                    ...
                                    <tr runat="server" id="row_termino_error" visible="false">
                                        <td colspan="2">
