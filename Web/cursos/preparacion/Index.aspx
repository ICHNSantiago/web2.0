...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <meta name="description" content="Norteamericano, Cursos de Inglés para adultos, TOEFL, PTE, English Courses, Teachers, jovenes, niños niñas, empresas  regulares e intensivos. Somos expertos en la enseñanza presencial. curso de inglés, español">
    <title>Norteamericano - Cursos Preparación</title>
    ...
    <div class="container-fluid feature alert-secondary pb-5">
        <div class="container pb-5">
            ...
            <div class="text-center mx-auto pb-5" style="max-width: 1000px;">
                <h4 class="text-primary">Curso de</h4>
                <h1 class="display-4 mb-4">Preparación </h1>
            ...
            <div class="row g-4 justify-content-center">
                    ...
                    <div class="service-item shadow article-card">
                        <a href="TOEFL.aspx">
                            <div class="service-img">
                                <img src="../../img/programas/cp_toefl.png" class="img-fluid rounded-top w-100" alt="">
                            </div>
                        </a>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 " runat="server" id="div_teens" style="display: block;">
                    <div class="service-item shadow article-card">
                        <a href="PTE.aspx">
                            <div class="service-img">
                                <img src="../../img/programas/cp_pte.png" class="img-fluid rounded-top w-100" alt="">
                            </div>
                        </a>
                        <div class="service-content p-4 bg-light rounded">
                            <div class="service-content-inner text-center">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 " runat="server" id="div1" style="display: block;">
                    <div class="service-item shadow article-card">
                        <a href="Teachers.aspx">
                            <div class="service-img">
                                <img src="../../img/programas/cp_teachers.png" class="img-fluid rounded-top w-100" alt="">
                            </div>
                        </a>
                        <div class="service-content p-4 bg-light rounded">
                            <div class="service-content-inner text-center">
                                <a class="btn btn-primary rounded-pill py-2 px-4" href="Teachers.aspx">Saber más</a>
                            </div>
                        </div>
                    </div>
                </div>
