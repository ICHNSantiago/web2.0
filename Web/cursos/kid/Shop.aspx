<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Shop.aspx.cs" Inherits="Web.cursos.kid.Shop" %>
                                    ...
                                    <tr class="text-center" runat="server" id="row_con_promo_regular">
                                        <th colspan="2">
                                            ...
                                            <h1 class="text-primary">$
                                                <asp:Label ID="LabelTarifaRegularDescto" runat="server" Text="Label"></asp:Label></h1>
                                        </th>
                                    </tr>
                                    <tr class="text-center">
                                        <th colspan="2">
