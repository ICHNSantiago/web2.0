<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="abcd.aspx.cs" Inherits="Web.abcd" %>
    ...
    <div class="container-fluid service">
        <div class="row g-1">
            <div class="col-md-9">
                <div class="row g-1">
                    <div class="col-md-12">
                        <a href="https://norteamericano.cl/cursos/adults/Index.aspx">
                            <img class="img-fluid" src="img/test/test01.png" />
                        </a>

                    </div>
                    <div class="col-md-4">
                        <a href="https://norteamericano.cl/cursos/kid/Index.aspx">
                            <img class="img-fluid" src="img/test/test03.png" />
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="https://norteamericano.cl/cursos/empresas/Index.aspx">
                            <img class="img-fluid" src="img/test/test04.png" />
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="https://norteamericano.cl/Fundacion.aspx">
                            <img class="img-fluid" src="img/test/test05.png" />
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <a href="https://norteamericano.cl/cursos/teen/Index.aspx">
                    <img class="img-fluid" src="img/test/test02.png" />
                </a>
            </div>
        </div>
    </div>
