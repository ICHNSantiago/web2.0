<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="NorteamericanoEXP.aspx.cs" Inherits="Web.FundacionPage.NorteamericanoEXP" %>
            ...
            <div class="row g-5">
                    ...
                    <div class="bg-white rounded p-5 ">
                        <div class="row ">
                            <div class="col-md-8">
                                ...
                                <h5 style="font-family: Work Sans; font-weight: 600; font-size: 36px;line-height: 130%; letter-spacing: 0%; " >Norteamericano Experience</h5>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="col-md-12 ">
                    <div class="bg-white rounded p-5 ">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img class="img-fluid rounded" src="../../img/fundacion/f06.webp" />
                            </div>
                            ...
                            <div class="col-md-8 text-dark" style="font-family: Work Sans; font-weight: 400; font-size: 16px; line-height: 130%; letter-spacing: 0%; ">
                                ...
                                <span>¡Aprende inglés como nunca antes con nuestras experiencias inmersivas!
                                </span>
                                <br />
                                <br />
                                <span>Ofrecemos experiencias educativas inmersivas en inglés, a través de jornadas especiales (One Day Programs) y programas after-school. Juegos, competencias, cultura y trabajo en equipo para que los estudiantes vivan el idioma de forma activa, divertida y significativa.
                                </span>
                                <br />
                                <br />
                                <span>Spelling Bees, Scavenger Hunts, Quiz Bowls y más, directamente en tu colegio.
                                </span>
                                <br />
                                <br />
                                <br />
