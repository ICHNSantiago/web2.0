<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="ATE.aspx.cs" Inherits="Web.FundacionPage.ATE" %>
...
<meta name="description" content="Norteamericano, Cursos de Inglés para adolescentes, jovenes, regulares e intensivos. Somos expertos en la enseñanza presencial. curso de inglés, español">
    <title>ATE | Norteamericano </title>
            ...
            <div class="row g-5">               
                <div class="col-md-12">
                    <div class="ratio" style="--bs-aspect-ratio: 150%;">
                        <embed src="certificado_pertenencia.pdf" type="application/pdf" frameborder="0" >
                    </div>
                </div>
            </div>
        </div>
