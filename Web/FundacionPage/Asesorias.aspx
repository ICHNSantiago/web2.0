<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Asesorias.aspx.cs" Inherits="Web.FundacionPage.Asesorias" %>
            ...
            <div class="row g-5">
                <div class="col-md-12 ">
                    <div class="bg-white rounded p-5 ">
                        <div class="row ">
                            <div class="col-md-8">
                                <h4 class="text-primary" style="font-family: Work Sans;  font-weight: 600; font-size: 24px; line-height: 130%; letter-spacing: 0%;">Fundación Instituto Chileno Norteamericano</h4>
                                <h5 style="font-family: Work Sans; font-weight: 600; font-size: 36px; line-height: 130%; letter-spacing: 0%; ">Asesorías | <span class="text-primary">Educativas</span></h5>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="col-md-12 ">
                    <div class="bg-white rounded p-5 ">
                        ...
                        <div class="row text-dark" style="font-family: Work Sans; font-weight: 400; font-size: 16px; line-height: 130%; letter-spacing: 0%;">
                            <div class="col-md-4">
                                <img class="img-fluid rounded" src="../../img/fundacion/f08.webp" />
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <span>Diagnóstico, planificación y mejora continua del inglés en tu escuela</span>
                                <br />
                                <br />
                                <span>Programa que comienza con una evaluación diagnóstica y culmina con la implementación de planes de mejora en tres líneas:
                                </span>
                                <br />
                                <br />
                                <span>1. Evaluación Diagnóstica y Análisis de Datos
                                </span>
                                <br />
                                <span>2. Mejora del plan de inglés
                                </span>
                                <br />
                                <span>3. Implementación del plan lector
                                </span>
                                <br />
                                <br />
                                <span>Datos concretos. Resultados medibles. Acompañamiento personalizado.
                                </span>
                                <br />
                                <br />
                                <br />
