...
namespace Web.Admin.Banner
{
    public partial class Index : System.Web.UI.Page
    {
                ...
                for (int i = 0; i < data.Rows.Count; i++)
                {
                    ...
                    if (banner == id)
                    {
                        if (tipoBanner == varTipo)
                        {
                            ...
                            banner_preview.Src = "../../img/carousel/" + tipoBanner + "/" + data.Rows[i]["imagenUrl"].ToString();
        ...
        protected void LinkButtonGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string archivo = Server.MapPath("../../img/carousel/" + tipo + "/");
            ...
            string resultado = banner.Actualizar(bannerNum, tipo, nombre, link, activo);
