...
namespace Web.Diagnostico.Adults
{
    public partial class Advanced : System.Web.UI.Page
    {
                    ...
                    case 5:
                        ...
                        switch (opcion)
                        {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                Pregunta05_05.Visible = true;
                                Pregunta05op05.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 6:
                                Pregunta05_06.Visible = true;
                                Pregunta05op06.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            default:
                                break;
                        }
                    ...
                    case 6:
                        ...
                        switch (opcion)
                        {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                Pregunta06_05.Visible = true;
                                Pregunta06op05.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 6:
                                Pregunta06_06.Visible = true;
                                Pregunta06op06.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            default:
                                break;
                        }
                    ...
                    case 7:
                        ...
                        switch (opcion)
                        {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                Pregunta07_05.Visible = true;
                                Pregunta07op05.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 6:
                                Pregunta07_06.Visible = true;
                                Pregunta07op06.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            default:
                                break;
                        }
                    ...
                    case 8:
                        ...
                        switch (opcion)
                        {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                Pregunta08_05.Visible = true;
                                Pregunta08op05.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 6:
                                Pregunta08_06.Visible = true;
                                Pregunta08op06.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            default:
                                break;
                        }
                ...
                try
                {
                    ...
                    if (int.TryParse(result, out int nivel))
                    {
                        if (int.TryParse(result2, out int test))
                        {
                            ...
                            if (nivel == 145)
                            {
                                LabelTituloOpciones.Text = "Choose the correct word to complete each sentence.";
                                LabelQuestion.Text = "Advanced 1 | Question 01";
                            }
                            ...
                            if (nivel == 146)
                            {
                                ...
                                {
                                    case 1:
                                        LabelTituloOpciones.Text = "Choose the best word from the list to complete each sentence";
                                        break;
                                    case 2:
                                        LabelTituloOpciones.Text = "Choose the best word from the list to complete each sentence.";
                                        break;
                                    ...
                                    case 3:
                                        LabelTituloOpciones.Text = "Choose the best answer for each question.";
                                        break;
                                    default:
                                        break;
                                }

                                LabelQuestion.Text = "Advanced 2 | Question 01";
                            }
        ...
        protected void LinkButtonNext_Click(object sender, EventArgs e)
        {
            ...
            switch (pregunta)
            {
                ...
                case 5:
                    ...
                    if (nivel == 145)
                    {
                        LabelTituloAudio.Text = "Listen to sentences from the lecture. Choose the words you hear.";
                        myaudio.Src = "Audios/advanced1_1.mp3";
                    }
                    ...
                    if (nivel == 146)
                    {
                        ...
                        {
                            case 1:
                                LabelTituloAudio.Text = "Listen and match the statement with the correct person";
                                myaudio.Src = "Audios/advanced2_1.mp3";
                                break;
                            case 2:
                                LabelTituloAudio.Text = "Choose the best phrase to complete each piece of supporting evidence the speaker mentions..";
                                myaudio.Src = "Audios/advanced2_2_a.mp3";
                                break;
                            case 3:
                                LabelTituloAudio.Text = "Choose the best phrase to complete each piece of supporting evidence the speaker mentions.";
                                myaudio.Src = "Audios/advanced2_2_a.mp3";
                ...
                case 6:
                    ...
                    {
                        LabelTituloAudio.Text = "Listen to sentences from the lecture. Choose the words you hear.";
                        myaudio.Src = "Audios/advanced1_2.mp3";
                    }
                    ...
                    if (nivel == 146)
                    {
                        switch (tipo)
                        {
                            ...
                            case 2:
                                LabelTituloAudio.Text = "Choose the best phrase to complete each piece of supporting evidence the speaker mentions.";
                                myaudio.Src = "Audios/advanced2_2_b.mp3";
                                break;
                            case 3:
                                LabelTituloAudio.Text = "Choose the best phrase to complete each piece of supporting evidence the speaker mentions.";
                                myaudio.Src = "Audios/advanced2_2_b.mp3";
                ...
                case 7:
                    ...
                    {
                        LabelTituloAudio.Text = "Listen to sentences from the lecture. Choose the words you hear.";
                        myaudio.Src = "Audios/advanced1_3.mp3";
                    }
                    ...
                    if (nivel == 146)
                    {
                        switch (tipo)
                        {
                            ...
                            case 2:
                                LabelTituloAudio.Text = "Choose the best phrase to complete each piece of supporting evidence the speaker mentions.";
                                myaudio.Src = "Audios/advanced2_2_c.mp3";
                                break;
                            case 3:
                                LabelTituloAudio.Text = "Choose the best phrase to complete each piece of supporting evidence the speaker mentions.";
                                myaudio.Src = "Audios/advanced2_2_c.mp3";
                ...
                case 8:
                    ...
                    if (nivel == 145)
                    {
                        LabelTituloAudio.Text = "Listen to the excerpts. What is the speaker doing?";
                        myaudio.Src = "Audios/advanced1_4.mp3";
                    }
        ...
        protected void Pregunta05_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (Pregunta05op05.Checked)
            {
                LabelPregunta05R.Text = Pregunta05op05.Text;
            }

            if (Pregunta05op06.Checked)
            {
                LabelPregunta05R.Text = Pregunta05op06.Text;
            }
        }
        ...
        protected void Pregunta06_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (Pregunta06op05.Checked)
            {
                LabelPregunta06R.Text = Pregunta06op05.Text;
            }

            if (Pregunta06op06.Checked)
            {
                LabelPregunta06R.Text = Pregunta06op06.Text;
            }
        }
        ...
        protected void Pregunta07_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (Pregunta07op05.Checked)
            {
                LabelPregunta07R.Text = Pregunta07op05.Text;
            }

            if (Pregunta07op06.Checked)
            {
                LabelPregunta07R.Text = Pregunta07op06.Text;
            }
        }
        ...
        protected void Pregunta08_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (Pregunta08op05.Checked)
            {
                LabelPregunta08R.Text = Pregunta08op05.Text;
            }


            if (Pregunta08op06.Checked)
            {
                LabelPregunta08R.Text = Pregunta08op06.Text;
            }
        }
    }
}