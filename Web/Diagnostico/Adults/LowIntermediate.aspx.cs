...
namespace Web.Diagnostico.Adults
{
    public partial class LowIntermediate : System.Web.UI.Page
    {
        public void ValidaTest()
        {
            ...
            if (varNivel == 45)
            {
                LabelPregunta05R.Text = Pregunta05op01_text.Text.Trim() + "/" + Pregunta05op02_text.Text.Trim();
                LabelPregunta06R.Text = Pregunta06op01_text.Text.Trim() + "/" + Pregunta06op02_text.Text.Trim();
                LabelPregunta07R.Text = Pregunta07op01_text.Text.Trim() + "/" + Pregunta07op02_text.Text.Trim();
                // LabelPregunta08R.Text = Pregunta08op01_text.Text + ";" + Pregunta08op02_text.Text; 
            }
            ...
            switch (pregunta)
            {
                ...
                case 5:
                    ...
                    if (nivel == 45)
                    {
                        ...
                        myaudio.Src = "Audios/lowintermediate1.mp3";
                    }
                    ...
                    if (nivel == 46)
                    {
                        ...
                        myaudio.Src = "Audios/lowintermediate2.mp3";
                    }
