<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="LowIntermediate.aspx.cs" Inherits="Web.Diagnostico.Adults.LowIntermediate" %>
                ...
                <div class="row">
                    <div class="col-md-12" runat="server" id="titulo_opcion">
                        <div class="alert alert-warning shadow text-dark text-center">
                            <strong>In this section select the word or phrase that best completes each sentence.</strong>
                        </div>
                    </div>

                    <div class="col-md-12" runat="server" id="titulo_audio" visible="false">
                        <div class="alert alert-warning shadow text-dark text-center">
                            <strong>Listen to the conversation and complete the chart with good and bad points they mention. Write only one word                           
                            </strong>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row" runat="server" id="pregunta_05" visible="false">
                                    ...
                                    <div class="col-md-12" runat="server" id="Pregunta05_opciones">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
                                    ...
                                    <div class="col-md-12" runat="server" id="Pregunta05_texto">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                        <strong>Write only one word</strong>
                                                    </td>
                                                    <td>
                                                        <strong>Write only one word</strong>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta05op01_text" placeholder="GOD" autocomplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta05op02_text" placeholder="BAD" autocomplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <div class="row" runat="server" id="pregunta_06" visible="false">
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_06_opciones">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_06_texto">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta06op01_text" autocomplete="off" placeholder="GOD" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta06op02_text" autocomplete="off" placeholder="BAD" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <div class="row" runat="server" id="pregunta_07" visible="false">
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_07_texto">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta07op01_text" autocomplete="off" placeholder="GOD" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta07op02_text" autocomplete="off" placeholder="BAD" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_07_opciones">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table ">
                                ...
                                <div class="row" runat="server" id="pregunta_08" visible="false">
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_08_texto">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta08op01_text" autocomplete="off" placeholder="GOD" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta08op02_text" autocomplete="off" placeholder="BAD" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_08_opciones">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
