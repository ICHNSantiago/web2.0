<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="PreIntermediate.aspx.cs" Inherits="Web.Diagnostico.Adults.PreIntermediate" %>
                                    ...
                                    <div class="col-md-12" runat="server" id="Pregunta05_texto">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta05op01_text" placeholder="Write the answer"  autocomplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_06_texto">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta06op01_text" placeholder="Write the answer" autocomplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_07_texto">
                                        <div class="alert alert-light shadow text-dark">
                                           <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta07op01_text" placeholder="Write the answer" autocomplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-md-12" runat="server" id="pregunta_08_texto">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table table-borderless mb-0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="Pregunta08op01_text" placeholder="Write the answer" autocomplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
