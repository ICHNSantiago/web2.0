...
{
    public partial class UpperIntermediate : System.Web.UI.Page
    {
        public void ValidaTest()
        {
            ...
            if (varNivel == 47)
            {
                LabelPregunta05R.Text = Pregunta05op01_text.Text.Trim() + " " + Pregunta05op02_text.Text.Trim() + " " + Pregunta05op03_text.Text.Trim();
            }

            string respuesta = (LabelPregunta01R.Text + "/" + LabelPregunta02R.Text + "/" + LabelPregunta03R.Text + "/" + LabelPregunta04R.Text + "/" +
                LabelPregunta05R.Text + "/" + LabelPregunta06R.Text + "/" + LabelPregunta07R.Text + "/" + LabelPregunta08R.Text).ToLower();
                ...
                try
                {
                    ...
                    if (int.TryParse(result, out int nivel))
                    {
                        if (int.TryParse(result2, out int test))
                        {
                            ...
                            if (nivel == 47)
                            {
                                LabelQuestion.Text = "Upper-Intermediate 1 | Question 01";
                            }

                            if (nivel == 48)
                            {
                                LabelQuestion.Text = "Upper-Intermediate 2 | Question 01";
                            }
        ...
        protected void LinkButtonNext_Click(object sender, EventArgs e)
        {
            ...
            if (nivel == 47)
            {
                test = "Upper-Intermediate 1 |";
            }
            if (nivel == 48)
            {
                test = "Upper-Intermediate 2 |";
            }
            ...
            switch (pregunta)
            {
                ...
                case 5:
                    ...
                    if (nivel == 47)
                    {
                        ...
                        myaudio.Src = "Audios/upperintermediate1.mp3";
                    }
                    ...
                    if (nivel == 48)
                    {
                        ...
                        myaudio.Src = "Audios/upperintermediate2.mp3";
                    }
