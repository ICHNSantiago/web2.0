<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="PreIntermediate.aspx.cs" Inherits="Web.Diagnostico.Kid.PreIntermediate" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row" runat="server" id="pregunta_01">
                                    ...
                                    <div class="col-md-5">
                                        <img class="img-fluid rounded" src="img/18/kid01.png" />
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="row" runat="server" id="pregunta_02" visible="false">
                                    ...
                                    <div class="col-md-5">
                                        <img class="img-fluid rounded" src="img/18/kid02.png" />
                                    </div>
                                    <div class="col-md-7">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
                                ...
                                <div class="row" runat="server" id="pregunta_03" visible="false">
                                    ...
                                    <div class="col-md-5">
                                        <img class="img-fluid rounded" src="img/18/kid03.png" />
                                    </div>
                                    <div class="col-md-7">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
                                                <tr runat="server" id="Pregunta03_01" visible="false">
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="CheckBoxPregunta03op01" CssClass="text-dark" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_02" visible="false">
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="CheckBoxPregunta03op02" CssClass="text-dark" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_03" visible="false">
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="CheckBoxPregunta03op03" CssClass="text-dark" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_04" visible="false">
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="CheckBoxPregunta03op04" CssClass="text-dark" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_05" visible="false">
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="CheckBoxPregunta03op05" CssClass="text-dark" runat="server" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <div class="row" runat="server" id="pregunta_04" visible="false">
                                    ...
                                    <div class="col-md-5">
                                        <img class="img-fluid rounded" src="img/18/kid04.png" />
                                    </div>
                                    <div class="col-md-7">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table text-dark">
                                                <tr>
                                                    <th><h5>Choose two words from the box</h5></th>
                                                </tr>
                                            </table>
                                            <table class="table table-primary table-bordered text-dark text-center">
                                                <tr>
                                                    <th>sunny</th>
                                                    <th>windy</th>
                                                    <th>hot</th>
                                            ...
                                            <table class="table text-dark">
                                                <tr>
                                                    <th class="text-end">Today it’s</th>
                                                    <td>
                                                        <asp:TextBox ID="TextBox_04_01" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <th class="text-end">and</th>
                                                    <td>
                                                        <asp:TextBox ID="TextBox_04_02" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
