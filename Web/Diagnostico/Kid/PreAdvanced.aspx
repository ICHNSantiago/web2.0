<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="PreAdvanced.aspx.cs" Inherits="Web.Diagnostico.Kid.PreAdvanced" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row" runat="server" id="pregunta_01">
                                    ...
                                    <div class="col-md-5">
                                        <img class="img-fluid" src="img/21/kid01.png" />
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="row" runat="server" id="pregunta_03" visible="false">
                                    ...
                                    <div class="col-md-5">
                                        <img class="img-fluid" src="img/21/kid02.png" />
                                    </div>
                                    <div class="col-md-7">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
                                ...
                                <div class="row" runat="server" id="pregunta_04" visible="false">
                                    ...
                                    <div class="col-md-5">
                                        <img class="img-fluid" src="img/21/kid03.png" />
                                    </div>
                                    <div class="col-md-7">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
