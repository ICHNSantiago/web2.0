...
namespace Web.Diagnostico.Kid
{
    public partial class PreIntermediate : System.Web.UI.Page
    {
        public void ValidaTest()
        {
            ...
            string respuesta03 = string.Empty;
            if (CheckBoxPregunta03op01.Checked) 
            {
                respuesta03 += CheckBoxPregunta03op01.Text;
            }
            if (CheckBoxPregunta03op02.Checked)
            {
                respuesta03 += " " + CheckBoxPregunta03op02.Text;
            }
            if (CheckBoxPregunta03op03.Checked)
            {
                respuesta03 += " " + CheckBoxPregunta03op03.Text;
            }
            if (CheckBoxPregunta03op04.Checked)
            {
                respuesta03 += " " + CheckBoxPregunta03op04.Text;
            }
            if (CheckBoxPregunta03op05.Checked)
            {
                respuesta03 += " " + CheckBoxPregunta03op05.Text;
            }

            LabelPregunta03R.Text = respuesta03;

            LabelPregunta04R.Text = TextBox_04_01.Text + " " + TextBox_04_02.Text; 
                    ...
                    case 3:
                        ...
                        switch (opcion)
                        {
                            case 1:
                                ...
                                CheckBoxPregunta03op01.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 2:
                                Pregunta03_02.Visible = true;
                                CheckBoxPregunta03op02.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 3:
                                Pregunta03_03.Visible = true;
                                CheckBoxPregunta03op03.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 4:
                                Pregunta03_04.Visible = true;
                                CheckBoxPregunta03op04.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            case 5:
                                Pregunta03_05.Visible = true;
                                CheckBoxPregunta03op05.Text = data.Rows[i]["respuestaNombre"].ToString();
                                break;
                            default:
                                break;
                        }
                ...
                try
                {
                    ...
                    if (int.TryParse(result, out int nivel))
                    {
                        if (int.TryParse(result2, out int test))
                        {
                            ...
                            LabelQuestion.Text = "Pre-Intermediate | Question 01";
