<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="UpperIntermediate.aspx.cs" Inherits="Web.Diagnostico.Teens.UpperIntermediate" %>
                ...
                <div class="row">
                    <div class="col-md-12" runat="server" id="titulo_opcion">
                        <div class="alert alert-warning shadow text-dark text-center">
                            <strong>Social language - discuss what to eat.
                                <br />
                                <small>Read the conversation and then answer the questions with the correct option.</small>
                            </strong>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row" runat="server" id="pregunta_01">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-light shadow text-dark">
                                            <img class="img-fluid rounded" src="img/34/pregunta1.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="alert alert-light shadow text-dark text-center">
                                            <table class="table text-dark">
                                                <tr>
                                                    <th>Maggie </th>
                                                    <td>Hey Jean. Sorry I’m late! I’m starving!</td>
                                                </tr>
                                                <tr>
                                                    <th>Jean</th>
                                                    <td>Me too. Let’s have something to eat.</td>
                                                </tr>
                                                <tr>
                                                    <th>Maggie</th>
                                                    <td>Ok! What is there?</td>
                                                </tr>
                                                <tr>
                                                    <th>Jean</th>
                                                    <td>Well, there are lots of cookies, and there’s a little cake.</td>
                                                </tr>
                                                <tr>
                                                    <th>Maggie</th>
                                                    <td>What about pretzels?</td>
                                                </tr>
                                                <tr>
                                                    <th>Jean</th>
                                                    <td>Oh, yeah. There are a few pretzels.</td>
                                                </tr>
                                                <tr>
                                                    <th>Maggie</th>
                                                    <td>Great! I’m in the mood for something salty.</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                ...
                                <div class="row" runat="server" id="pregunta_03" visible="false">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-light shadow text-dark">
                                            <img class="img-fluid rounded" src="img/34/pregunta2.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="alert alert-light shadow text-dark text-center">
                                            <table class="table text-dark">
                                                <tr>
                                                    <th>A:</th>
                                                    <td>Are you a new student?</td>
                                                </tr>
                                                <tr>
                                                    <th>B:</th>
                                                    <td>Yes, I am. I think I’m lost.</td>
                                                </tr>
                                                <tr>
                                                    <th>A:</th>
                                                    <td>I can help you. I’m Makiko.</td>
                                                </tr>
                                                <tr>
                                                    <th>B:</th>
                                                    <td>Nice to meet you, Matt. I’m Carlos. How do I get to the science lab?</td>
                                                </tr>
                                                <tr>
                                                    <th>A:</th>
                                                    <td>Oh, that’s easy. Go upstairs to the second floor. It’s on the right. Room 202. You can’t miss it.</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
