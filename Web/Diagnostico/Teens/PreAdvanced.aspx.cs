...
namespace Web.Diagnostico.Teens
{
    public partial class PreAdvanced : System.Web.UI.Page
    {
        public void ValidaTest()
        {
            ...
            if (varNivel == 35)
            {
                LabelPregunta05R.Text = TextBoxPregunta05.Text;
                LabelPregunta06R.Text = TextBoxPregunta06.Text;
                LabelPregunta07R.Text = TextBoxPregunta07.Text;
                LabelPregunta08R.Text = TextBoxPregunta08.Text;
            }
        ...
        public void CargaTest(int nivel, int test)
        {
            ...
            DataTable data = ndiagnostico.PruebaTeens(nivel, test);
            ...
            for (int i = 0; i < data.Rows.Count; i++)
            {
                ...
                switch (pregunta)
                {
                    case 1:
                        ...
                        if(nivel == 35)
                        {
                            img_01.Src = "img/35/pregunta1.jpg";
                        }
                        else if (nivel == 36)
                        {
                            img_01.Src = "img/36/pregunta1.jpg";
                        }
                    ...
                    case 2:
                        ...
                        if (nivel == 35)
                        {
                            img_02.Src = "img/35/pregunta2.jpg";
                        }
                        else if (nivel == 36)
                        {
                            img_02.Src = "img/36/pregunta2.jpg";
                        }
                    ...
                    case 3:
                        ...
                        if (nivel == 35)
                        {
                            img_03.Src = "img/35/pregunta3.jpg";
                        }
                        else if (nivel == 36)
                        {
                            img_03.Src = "img/36/pregunta3.jpg";
                        }
                    ...
                    case 4:
                        ...
                        if (nivel == 35)
                        {
                            img_04.Src = "img/35/pregunta4.jpg";
                        }
                        else if (nivel == 36)
                        {
                            img_04.Src = "img/36/pregunta4.jpg";
                        }
            ...
            switch (pregunta)
            {
                ...
                case 5:
                    ...
                    if (nivel == 35)
                    {
                        ...
                        myaudio.Src = "Audios/LEVEL_205.mp3";
                        pregunta_05_texto.Visible = true;
                        pregunta_05_opciones.Visible = false;
                        LabelPregunta05.Visible = false;
                        pregunta_05_titulo.Visible = false;
                    }
                    else if (nivel == 36)
                    {
                        titulo_audio.Visible = true;
                        ...
                        pregunta_05.Visible = true;
                        LabelQuestion.Text = test + " Question 05";
                        myaudio.Src = "Audios/LEVEL_206.mp3";
                        pregunta_05_texto.Visible = false;
                        pregunta_05_opciones.Visible = true;
                        LabelPregunta05.Visible = true;
                        pregunta_05_titulo.Visible = true;
                    }
                    break;
                case 6:
