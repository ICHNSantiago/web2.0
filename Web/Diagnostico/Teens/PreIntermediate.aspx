<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="PreIntermediate.aspx.cs" Inherits="Web.Diagnostico.Teens.PreIntermediate" %>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row" runat="server" id="pregunta_01">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-light shadow text-dark">
                                            <img class="img-fluid rounded" src="img/32/pregunta1.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="alert alert-light shadow text-dark">
                                ...
                                <div class="row" runat="server" id="pregunta_02" visible="false">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-light shadow text-dark">
                                            <img class="img-fluid rounded" src="img/32/pregunta2.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="alert alert-light shadow text-dark">
                                ...
                                <div class="row" runat="server" id="pregunta_03" visible="false">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-light shadow text-dark">
                                            <img class="img-fluid rounded" src="img/32/pregunta3.png" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="alert alert-light shadow text-dark">
                                            <table class="table">
                                                <tr runat="server" id="Pregunta03_01">
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="Pregunta03op01" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta03_CheckedChanged" Text="Beans" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_02" >
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="Pregunta03op02" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta03_CheckedChanged" Text="Apples" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_03" >
                                                    <td class="checkIchn">

                                                        <asp:CheckBox ID="Pregunta03op03" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta03_CheckedChanged" Text="Potatoes" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_04" >
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="Pregunta03op04" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta03_CheckedChanged" Text="Tomatoes" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_05" >
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="Pregunta03op05" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta03_CheckedChanged" Text="Peppers" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_06" >
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="Pregunta03op06" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta03_CheckedChanged" Text="Onions" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_07" >
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="Pregunta03op07" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta07_CheckedChanged" Text="Oranges" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr runat="server" id="Pregunta03_08" >
                                                    <td class="checkIchn">
                                                        <asp:CheckBox ID="Pregunta03op08" CssClass="text-dark" Font-Size="Larger" OnCheckedChanged="Pregunta07_CheckedChanged" Text="Bananas" runat="server" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="d-grid gap-2">
                            <asp:LinkButton ID="LinkButtonNext" class="btn btn-primary" runat="server" OnClick="LinkButtonNext_Click">Next</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
