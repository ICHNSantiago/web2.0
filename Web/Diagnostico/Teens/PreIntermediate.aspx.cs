...
namespace Web.Diagnostico.Teens
{
    public partial class PreIntermediate : System.Web.UI.Page
    {
        public void ValidaTest()
        {
            ...
            {
                respuesta3 += " " + Pregunta03op01.Text;
            }

            if (Pregunta03op02.Checked)
            {
                respuesta3 += " " + Pregunta03op02.Text;
            }

            if (Pregunta03op03.Checked)
            {
                respuesta3 += " " + Pregunta03op03.Text;
            }

            if (Pregunta03op04.Checked)
            {
                respuesta3 += " " + Pregunta03op04.Text;
            }

            if (Pregunta03op05.Checked)
            {
                respuesta3 += " " + Pregunta03op05.Text;
            }

            if (Pregunta03op06.Checked)
            {
                respuesta3 += " " + Pregunta03op06.Text;
            }

            if (Pregunta03op07.Checked)
            {
                respuesta3 += " " + Pregunta03op07.Text;
            }

            if (Pregunta03op08.Checked)
            {
                respuesta3 += " " + Pregunta03op08.Text;
            }

            LabelPregunta03R.Text = respuesta3;
                ...
                try
                {
                    ...
                    if (int.TryParse(result, out int nivel))
                    {
                        if (int.TryParse(result2, out int test))
                        {
                            ...
                            LabelQuestion.Text = "PreIntermediate | Question 01";
                        }
                        else
                        {
        ...
        protected void LinkButtonNext_Click(object sender, EventArgs e)
        {
            ...
            switch (pregunta)
            {
                ...
                case 4:
                    ...
                    myaudio.Src = "Audios/LEVEL_202.mp3";
                    break;
                case 5:
                    titulo_audio.Visible = true;
                    div_audio.Visible = true;
                ...
                case 7:
                    ...
                    myaudio.Src = "Audios/LEVEL_202.mp3";
                    LinkButtonNext.Attributes.Clear();
                    LinkButtonNext.Attributes.Add("class", "btn btn-primary cargando");
                    break;
                case 8:
                    ValidaTest();
                    break;
