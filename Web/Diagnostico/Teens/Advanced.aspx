<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Advanced.aspx.cs" Inherits="Web.Diagnostico.Teens.Advanced" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row" runat="server" id="pregunta_01">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-light shadow text-dark">
                                            <img class="img-fluid rounded" src="img/37/pregunta1.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="alert alert-light shadow text-dark">
                                ...
                                <div class="row" runat="server" id="pregunta_02" visible="false">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-light shadow text-dark">
                                            <img class="img-fluid rounded" src="img/37/pregunta2.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="alert alert-light shadow text-dark">
                                ...
                                <div class="row" runat="server" id="pregunta_03" visible="false">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-primary shadow text-dark text-center">
                                           <h4>
                                                “My aunt was at the bank and she heard this guy yell “Give me all the money!” She said it was really scary”
                                           </h4>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                ...
                                <div class="row" runat="server" id="pregunta_04" visible="false">
                                    ...
                                    <div class="col-md-4">
                                        <div class="alert alert-primary shadow text-dark text-center">
                                         <h4>
                                               “When I was shopping for clothes at the mall, I saw a woman put a skirt in her bag. She didn’t pay for it!”
                                         </h4>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
