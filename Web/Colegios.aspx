<%@ Page Title="" Language="C#" MasterPageFile="~/Ichn.Master" AutoEventWireup="true" CodeBehind="Colegios.aspx.cs" Inherits="Web.Colegios" %>
            ...
            <div class="row g-5" runat="server" id="div_main">
                ...
                <div class="col-md-12 mt-5 text-center">
                    ...
                    <a style="text-transform: uppercase" data-bs-toggle="modal" data-bs-target="#portfolioModal1" class="btn btn-danger rounded-pill py-2 px-4">
                        <span class="me-3 ms-3" style="font-family: Work Sans; font-weight: 600; font-size: 20px; line-height: 100%; letter-spacing: 10%; text-align: center; text-transform: uppercase;">Contacto programas y alianzas colegios</span></a>
                </div>
